  ...
  return (
    <Fragment>
      <main style={{ height: "auto", marginTop: "10px", marginBottom: "50px" }}>
        {/* Hero Section */}
        <section id="insurance-section" className="hero-section2 px-5">
          <Container>
            <h1 className="font-bold text-[24px]">Контакты</h1>
            <div className="bg" style={{backgroundColor: "#F5F7FA", padding: "20px 45px", paddingBottom: "560px", borderRadius: "10px", margin: "20px 0"}}>
                <div className="nf flex justify-between gap-5 my-4">
                ...
                <div className="nf2 flex justify-between gap-5">
