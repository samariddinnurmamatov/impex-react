  ...
  return (
    <Fragment>
      <main style={{ height: "auto", marginBottom: "50px" }}>
        ...
        {/* Offers Section */}
        <section className="offers mt-[15px] mb-[60px]">
          <Container>
       ...
       <section className="about-us  relative bottom-[180px]" style={{ paddingBottom: "100px" }}>
          <Container>
            ...
            <div className="flex">
              <div
                style={{ backgroundColor: "#F5F7FA" ,width: "60%"  }}
                className="rounded-md relative flex pt-[104px] pl-[40px] pb-[48px]"
              >
                {/* <div className=> */}
                  <div>
                  ...
                  <p className="about-us__description text-[14px] leading-[20px] mt-[30px] mb-[40px]">
                    Компания, основанная в 2021 году в Узбекистане ,<br /> обладающая
                    полным набором страховых услуг, представляет <br /> высококачественные
                    продукты и обслуживание благодаря <br />опытной команде профессионалов и
                    уставному капиталу <br /> в 45 млрд сумов.
                  </p>
                  <a
                    href="#"
                ...
                <div style={{ width: "40%" }}>
                    <img className="w-[536px] h-[431px]" src={Impexabout} alt="" />
                  </div>
              </div>
            {/* </div> */}
          </Container>
        ...
        <section>
            <Container>
                <div className="flex items-center justify-between relative bg-dark-blue px-[26px]">
